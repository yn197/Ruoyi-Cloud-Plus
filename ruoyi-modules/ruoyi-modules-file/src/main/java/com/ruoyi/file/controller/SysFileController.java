...
public class SysFileController {
    ...
    public R<String> upload(@RequestParam("file") MultipartFile file,
        ...
        try {
            ...
            minioUtils.uploadFile(Objects.isNull(bucketName) ? minioConfig.getBucketName() : bucketName, file, uuid, contentType);
            //保存文件信息
            SysUploadFile sysUploadFile = new SysUploadFile();
            sysUploadFile.setFileName(file.getOriginalFilename());
            sysUploadFile.setFileId(uuid);
            sysUploadFile.setBucketName(Objects.isNull(bucketName) ? minioConfig.getBucketName() : bucketName);
